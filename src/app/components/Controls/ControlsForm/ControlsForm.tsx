...
const ControlsForm = () => {
  ...
  const handleInputChange =
    ...
    (event: React.ChangeEvent<HTMLInputElement | HTMLTextAreaElement>) => {
      ...
      const newValidationState = { ...formValidation };
      ...
      setIsFormValid(
        newValidationState.inputValid &&
          newValidationState.textAreaValid &&
          newValidationState.hasImages
      );
    };
  ...
  useEffect(() => {
    ...
    const newValidationState = { ...formValidation, hasImages };
